...
ggplot(refrac_curve, aes(x = Sample, y = Species, color = Site))+ ylab("Genera") + xlab("Sample Size") + theme_bw() +geom_line(size=1.2) + labs(title = "Tarigrade Genus Distribution across Countries")+ theme(plot.title = element_text(hjust = 0.5), legend.title=element_blank()) +  scale_color_manual(values=c("#999999", "#56B4E9", "#E69F00", "#009E73", "#CC79A7", "#D55E00"))
